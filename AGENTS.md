...
- Before delivery, run `html2style bundle` and return the resulting `design-package/`. A later Agent session must start from `AGENT-HANDOFF.md`, not the original chat.
